	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
				healthBarColor = FlxColor.fromRGB(97, 0, 130);
			case 'cheeky':
				switch(PlayState.SONG.song.toLowerCase()){
					case 'bad eggroll': 
						tex = Paths.getSparrowAtlas('mugen/week3/characters/Mad Cheeky');
					default: 
						tex = Paths.getSparrowAtlas('mugen/week1/characters/Cheeky');
				}
				frames = tex;
			...
			case 'chonka':
				tex = Paths.getSparrowAtlas('mugen/week1/characters/CHONKA');
				frames = tex;
				animation.addByPrefix('idle', 'CHONKA', 24);
				...
				healthBarColor = FlxColor.fromRGB(110, 179, 204);
			case 'cheekymad':
				tex = Paths.getSparrowAtlas('mugen/week2/characters/potato');
				frames = tex;
				animation.addByPrefix('idle', 'Cheeky Idle Dance', 24);
				animation.addByPrefix('singUP', 'Cheeky NOTE UP', 24, false);
				animation.addByPrefix('singRIGHT', 'Cheeky NOTE RIGHT', 32, false);
				...
				healthBarColor = FlxColor.fromRGB(110, 179, 204);
			case 'cheeky-cool':
				tex = Paths.getSparrowAtlas('mugen/week2/characters/burnedpotato');
				frames = tex;
				animation.addByPrefix('idle', 'Cheeky Idle Dance', 24);
				animation.addByPrefix('singUP', 'Cheeky NOTE UP', 24, false);
				animation.addByPrefix('singRIGHT', 'Cheeky NOTE RIGHT', 32, false);
				...
				healthBarColor = FlxColor.fromRGB(110, 179, 204);
			case 'omen':
				tex = Paths.getSparrowAtlas('mugen/OMEN/omen');
				frames = tex;
				...
				playAnim('idle');
				healthBarColor = FlxColor.fromRGB(105, 105, 105);
			case 'ron': 
				tex = Paths.getSparrowAtlas('mugen/ron/RON');
				frames = tex;
				animation.addByPrefix('idle', 'RON Idle Dance', 24);
				animation.addByPrefix('singUP', 'RON NOTE UP', 24, false);
				animation.addByPrefix('singRIGHT', 'RON NOTE RIGHT', 32, false);
				animation.addByPrefix('singDOWN', 'RON NOTE DOWN', 32, false);
				animation.addByPrefix('singLEFT', 'RON NOTE LEFT', 24, false);
				animation.addByPrefix('Ugh', 'RON Cool Ass Pose', 24, false);

				addOffset('idle');
				addOffset("singUP", 30, -20);
				addOffset("singRIGHT", -50, -59);
				addOffset("singLEFT", 160, -80);
				addOffset("singDOWN", 20, -122);
				addOffset("Ugh", -30, -70);

				playAnim('idle');
				healthBarColor = FlxColor.fromRGB(237, 255, 138);
			case 'cheekygun':
				tex = Paths.getSparrowAtlas('mugen/week1/characters/cheekgun');
				frames = tex;
				animation.addByPrefix('idle', 'Cheeky Idle Dance', 24);
				animation.addByPrefix('singUP', 'Cheeky NOTE UP', 24, false);
			...
			case 'spooky':
				...
				healthBarColor = FlxColor.fromRGB(255, 176, 84);
			case 'mom':
			...
			case 'pico':
				...
				healthBarColor = FlxColor.fromRGB(0, 255, 127);
			case 'bf':
			...
			case 'cheeky-Scared': 
				...
				healthBarColor = FlxColor.fromRGB(110, 179, 204);
			case 'bf-bob':
				var tex = Paths.getSparrowAtlas('mugen/week3/characters/bob_play');
				frames = tex;
				...
				playAnim('idle');
				flipX = true;
				healthBarColor = FlxColor.fromRGB(255, 255, 255);
			case 'bf-cool':
				trace('hi');
				var tex = Paths.getSparrowAtlas('mugen/week2/characters/purple_BF');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'senpai':
				...
				antialiasing = false;
				healthBarColor = FlxColor.fromRGB(245,222,179);
			case 'senpai-angry':
				frames = Paths.getSparrowAtlas('characters/senpai');
